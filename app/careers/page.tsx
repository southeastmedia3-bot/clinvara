  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-12 lg:px-8">
      ...
      <p className="mt-5 max-w-3xl text-sm leading-relaxed text-[var(--brand-text-muted)]">
        ...
        education, customer experience, design, content, and operations. Current
        openings will be published here as roles become available.
      </p>

      <section className="mt-10 grid gap-4 md:grid-cols-3">
        {[
          ["Brand and Content", "Ingredient education, journal content, campaign copy, and skincare storytelling."],
          ["Customer Experience", "Order support, routine guidance, feedback loops, and service quality."],
          ["Growth and Operations", "Ecommerce operations, analytics, merchandising, and marketplace readiness."],
        ].map(([title, body]) => (
      ...
      <section className="mt-10 rounded-2xl bg-[var(--brand-off-white)] p-6">
        <h2 className="font-display text-2xl font-semibold">General applications</h2>
        ...
        <Link href="/contact" className="mt-5 inline-flex rounded-full bg-black px-6 py-3 text-sm font-semibold text-white">
          Contact Us
        </Link>
      </section>
    </main>
